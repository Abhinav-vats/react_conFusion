...
class Contact extends Component
{
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.telnum)
        {
            ...
            {
                errors.telnum = "Tel. Number should contain only 10 digit numbers";
            }
            ...
            <div className="container">
                <div className="row">
                    <Breadcrumb>
                        ...
                        <BreadcrumbItem acive>Contact Us</BreadcrumbItem>
                    </Breadcrumb>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                <Col md={{size: 10, offset: 2}}>
                                    <Button type="submit" color="success">Send Feedback</Button>
                                </Col>
                            </FormGroup>
